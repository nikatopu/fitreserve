...
export default function Memberships() {
  ...
  const tiers: Partial<Membership>[] = allMembershipsData || [
    {
      title: "Essential",
      description:
  ...
  return (
    <section className={style.container}>
      ...
      <Paragraph
        text="Select the level of access that aligns with your ambition."
        textAlign="center"
      />
          ...
          >
            ...
            {premiumTier.title === tier.title && (
              <Button
                ...
                onClick={() =>
                  (window.location.href = `/membership?tier=${tier.id}`)
                }
              />
            )}
